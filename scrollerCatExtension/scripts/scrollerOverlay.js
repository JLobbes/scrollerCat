...
(function () {
  ...
  function injectScrollerOverlay() {
    ...
    scrollerOverlay.prepareToolbar = function() {
      ...
      const curvingArrowIcon = chrome.runtime.getURL('images/curving-arrow-icon.png');
    ...
    scrollerOverlay.prepareSettingsPanel = function() {
      ...
      const daylightModeIcon = chrome.runtime.getURL('images/daylight-mode-icon.png');
      ...
      const nightModeIcon = chrome.runtime.getURL('images/night-mode-icon.png');
      this.settingsPanel.buttonContainers['nightMode'].addState(
          'nightModeOn', 
          nightModeIcon,
      ...
      const fontSizeMediumIcon = chrome.runtime.getURL('images/text-icon-med.png');
      ...
      const fontSizeLargeIcon = chrome.runtime.getURL('images/text-icon-large.png');
      this.settingsPanel.buttonContainers['adjustFontSize'].addState(
          'makeTextLarger', 
          fontSizeLargeIcon,
      ...
      const fontSizeLargestIcon = chrome.runtime.getURL('images/text-icon-largest.png');
      this.settingsPanel.buttonContainers['adjustFontSize'].addState(
          'makeTextLargest', 
          fontSizeLargestIcon,
      ...
      const fontSizeSmallestIcon = chrome.runtime.getURL('images/text-icon-smallest.png');
      this.settingsPanel.buttonContainers['adjustFontSize'].addState(
          'makeTextSmallest', 
      ...
      const fontSizeSmallIcon = chrome.runtime.getURL('images/text-icon-smaller.png');
      this.settingsPanel.buttonContainers['adjustFontSize'].addState(
          'makeTextSmaller', 
          fontSizeSmallIcon,
      ...
      const narrowestIcon = chrome.runtime.getURL('images/narrowest-icon.png');
      this.settingsPanel.buttonContainers['scrollerBoxWidth'].addState(
      ...
      const tallestIcon = chrome.runtime.getURL('images/tallest-icon.png');
      this.settingsPanel.buttonContainers['scrollerBoxHeight'].addState(
      ...
      const shortestIcon = chrome.runtime.getURL('images/shortest-icon.png');
      this.settingsPanel.buttonContainers['scrollerBoxHeight'].addState(
      ...
      const keypressDoubleIcon = chrome.runtime.getURL('images/keypress-double-icon.png');
      ...
      const pointerDoubleIcon = chrome.runtime.getURL('images/pointer-icon-double.png');
      ...
      const pointerTripleIcon = chrome.runtime.getURL('images/pointer-icon-triple.png');
      this.settingsPanel.buttonContainers['dragSpeed'].addState(
          'dragSpeedFastest', 
          pointerTripleIcon,
      ...
      const keypressSingleIcon = chrome.runtime.getURL('images/keypress-single-icon.png');
      this.settingsPanel.buttonContainers['dragSpeed'].addState(
          'dragSpeedSlow', 
          keypressSingleIcon,
      ...
      const sentenceScrollMediumIcon = chrome.runtime.getURL('images/sentence-scroll-med.gif');
      ...
      const sentenceScrollFastIcon = chrome.runtime.getURL('images/sentence-scroll-fast.gif');
      this.settingsPanel.buttonContainers['autoScroll'].addState(
          'autoScrollFastest', 
      ...
      const sentenceSwipeSlowIcon = chrome.runtime.getURL('images/sentence-swipe-slow.gif');
      this.settingsPanel.buttonContainers['autoScroll'].addState(
          'autoSwipeSlow', 
      ...
      const sentenceSwipeMediumIcon = chrome.runtime.getURL('images/sentence-swipe-med.gif');
      this.settingsPanel.buttonContainers['autoScroll'].addState(
          'autoSwipeFast', 
      ...
      const sentenceSwipeFastIcon = chrome.runtime.getURL('images/sentence-swipe-fast.gif');
      this.settingsPanel.buttonContainers['autoScroll'].addState(
          'autoSwipeFastest', 
      ...
      const sentenceScrollSlowIcon = chrome.runtime.getURL('images/sentence-scroll-slow.gif');
      this.settingsPanel.buttonContainers['autoScroll'].addState(
          'autoScrollSlow', 
    ...
    scrollerOverlay.prepareForInjection = function() {
      ...
      this.scrollerOverlayHTML.style.left = `${(screen.width / 2) - halfWidth}px`;
      const scrollerOverlayHeight = 400; //px
      const halfHeight = Math.floor(scrollerOverlayWidth / 2);
      this.scrollerOverlayHTML.style.top = `${(screen.right / 2) - halfHeight}px`;
