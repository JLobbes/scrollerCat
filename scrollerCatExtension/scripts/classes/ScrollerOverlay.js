...
(function () {
    class ScrollerOverlay {
        ...
        createHTMLContainer() {
            ...
            const hammerIconActive = chrome.runtime.getURL('images/hammer-icon-active.gif');
            toolbarCloseImg.id = 'settingsIconActive';
            toolbarCloseImg.src = hammerIconActive;
            toolbarCloseImg.classList.add('unselectable');
            toolbarCloseImg.alt = 'Jiggling hammer icon to indicate setting are open';
            ...
            internalDivider.classList.add('toggle-button-container', 'hidden-setting');
            ...
            const settingGearIcon = chrome.runtime.getURL('images/setting-gear-icon.png');
            ...
            settingsInternalDivider.classList.add('toggle-button-container', 'hidden-setting');
